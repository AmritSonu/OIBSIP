function getRandomPrice() {
  // Generates a random price between 30 and 50
...
function AddExtraToppings() {
  return (
    <>
      <ul className="my-2">
        {extraToppingsData.map((topping) => (
          <div className="px-4 py-2" key={topping.id}>
