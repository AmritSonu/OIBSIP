    ...
    <div className="flex items-center justify-center mt-6 mb-6 ">
      <div className="w-full max-w-md rounded-lg p-6">
        ...
        <form className="flex flex-col " onSubmit={handleSubmit}>
          ...
          <button
            className="bg-mainAdditionalcolor-150 text-white font-bold py-2 px-4 rounded-md mt-4 hover:bg-indigo-600 hover:to-blue-600 transition ease-in-out duration-150"
            type="submit"
          >
            Sign Up
          </button>
