...
function CustomerOrderPreview() {
  ...
  return (
    <div>
      <OrderPreviewHeader handleBack={handleBack} />
      <div className="bg-gray-100 min-h-screen p-4">
        ...
        <div className="py-4 my-4 bg-white rounded-lg shadow-sm flex flex-col gap-3 font-semibold text-gray-700 px-6">
...
function OrderPreviewHeader({ handleBack }) {
  return (
    <div className="bg-mainAdditionalcolor-150 flex items-center justify-between px-5 py-3">
